...
//Upload image through a different route
...
//Adds user details such as bio, website etc
exports.addUserDetails =(req,res)=>{
    let userDetails=reduceUserDetails(req.body);            //reduceUserDetails validates the incoming data
